# App Settings ====================================================================================================
app_name = "dream:book"                 # App name, displayed in the title bar
app_proportions = [800, 450]            # Width, Height
app_resizable = False                   # Allow the window to be resized
...
app_fullscreen = True                   # Create a fullscreen window.
